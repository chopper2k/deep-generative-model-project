...
@register_model('transformer_concat_with_graph_copy2')
...
@register_model_architecture('transformer_concat_with_graph_copy2', 'transformer_concat_with_graph_copy2')
...
@register_model_architecture('transformer_concat_with_graph_copy2', 'transformer_concat_with_graph_copy_gigaword2')
...
@register_model_architecture('transformer_concat_with_graph_copy2', 'transformer_concat_with_graph_copy_gigaword_big2')
def transformer_concat_with_graph_copy_gigaword_big2(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.graph_attention_heads = getattr(args, 'graph_attention_heads', 4)
...
@register_model_architecture('transformer_concat_with_graph_copy2', 'transformer_concat_with_graph_copy_gigaword_big32')
...
@register_model_architecture('transformer_concat_with_graph_copy2', 'transformer_concat_with_graph_copy_gigaword_big42')
def transformer_concat_with_graph_copy_gigaword_big2(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
