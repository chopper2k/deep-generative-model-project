...
@register_model('transformer_concat_with_graph_copy')
...
@register_model_architecture('transformer_concat_with_graph_copy', 'transformer_concat_with_graph_copy')
...
@register_model_architecture('transformer_concat_with_graph_copy', 'transformer_concat_with_graph_copy_gigaword')
...
@register_model_architecture('transformer_concat_with_graph_copy', 'transformer_concat_with_graph_copy_gigaword_big')
...
@register_model_architecture('transformer_concat_with_graph_copy', 'transformer_concat_with_graph_copy_gigaword_big3')
...
@register_model_architecture('transformer_concat_with_graph_copy', 'transformer_concat_with_graph_copy_gigaword_big4')
def transformer_concat_with_graph_copy_gigaword_big2(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
